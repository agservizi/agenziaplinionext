...
export default function FloatingContact() {
  ...
  const whatsappUrl = `https://wa.me/${company.whatsapp}?text=${encodeURIComponent("Ciao! Vorrei ricevere informazioni sui vostri servizi.")}`;
            ...
            {expanded && (
              ...
              >
                <a
                  ...
                  className="flex min-h-[44px] items-center gap-3 rounded-full bg-[#25D366] px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-[#25D366]/30 transition hover:bg-[#20c05c]"
                >
                ...
                <a
                  ...
                  className="flex min-h-[44px] items-center gap-3 rounded-full bg-slate-800 px-4 py-2.5 text-sm font-semibold text-white shadow-lg transition hover:bg-slate-700"
                >
