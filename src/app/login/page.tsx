...
export const metadata: Metadata = {
  ...
  description: "Accedi o registrati all'area clienti AG SERVIZI per gestire spedizioni, visure, CAF e servizi digitali.",
      ...
      <div className="relative flex flex-1 items-center justify-center px-6 py-16 md:px-10 lg:py-12">
        ...
        <div className="relative w-full max-w-[380px] space-y-8">
          ...
          <div className="space-y-2 text-center lg:text-left">
            <h2 className="text-2xl font-black text-white tracking-tight">Entra nel tuo spazio</h2>
            <p className="text-sm text-white/40">
              Spedizioni, visure, pratiche e documenti. Tutto in un posto.
            </p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 shadow-2xl shadow-black/40 backdrop-blur-sm">
            <Suspense
              fallback={
          ...
          <div className="space-y-3 text-center">
            <p className="text-xs text-white/25">
              Sei un operatore?{" "}
              <Link href="/admin-login" className="text-white/40 underline underline-offset-2 transition hover:text-white/70">
                Area admin
              </Link>
            </p>
