...
export function generateMetadata() {
  return buildMetadata({
    title: "Telefonia e Internet a Castellammare di Stabia",
    description:
    ...
    <div className="pb-24">
        ...
        <Container className="grid gap-12 md:grid-cols-[1.1fr_0.9fr] md:items-center">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl font-semibold text-white md:text-5xl">
              Telefonia e Internet a Castellammare di Stabia
            </h1>
      ...
      <div className="lux-surface pt-10 text-slate-900">
        <section className="py-10">
          <Container>
            <SectionHeading
              eyebrow="Operatori e offerte"
              title="Soluzioni di telefonia su misura"
              description="Analizziamo esigenze e consumi per attivazioni rapide e affidabili."
              tone="dark"
            />
          </Container>
        </section>
        ...
        <section className="py-12">
          <Container className="lux-panel rounded-3xl p-8">
            <h2 className="text-xl font-semibold text-slate-900">
              Assistenza telefonia locale a Castellammare di Stabia
            </h2>
            <p className="mt-3 text-sm text-slate-600">
              Configurazione, portabilità e gestione pratiche con supporto in sede.
              Un unico referente per attivazioni e assistenza.
            </p>
          </Container>
        </section>
      </div>
