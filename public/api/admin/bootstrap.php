...
function admin_api_ensure_client_area_consulting_leads_table(): void
{
    $db = admin_api_require_db();
...
function admin_api_ensure_client_area_web_agency_projects_table(): void
{
    $db = admin_api_require_db();
...
function admin_api_ensure_client_area_email_notifications_table(): void
{
    $db = admin_api_require_db();
